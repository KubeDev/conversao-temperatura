...
docker build -t desafio-1-conversao-temperatura>v1 .

Seguindo as boas práticas devemos criar a tag latest também 

tag desafio-1-conversao-temperatura:v1 desafio-1-conversao-temperatura:latest
...
docker container run -d -p 8080:8080 desafio-1-conversao-temperatura:v1
